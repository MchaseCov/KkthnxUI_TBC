...
function Module:CreateAFKCam()
	...
	AFKMode.chat:SetFontObject(KkthnxUIFont, nil, 12)
	...
	AFKMode.top.time:SetFontObject(KkthnxUIFont, nil, 16)
	...
	AFKMode.top.date:SetFontObject(KkthnxUIFont, nil, 16)
	...
	AFKMode.bottom.name:SetFontObject(KkthnxUIFont, nil, 20)
	...
	AFKMode.bottom.playerInfo:SetFontObject(KkthnxUIFont, nil, 20)
	...
	AFKMode.bottom.guild:SetFontObject(KkthnxUIFont, nil, 20)
	...
	AFKMode.statMsg.info:SetFontObject(KkthnxUIFont, nil, 18)
	...
	AFKMode.countd.text:SetFontObject(KkthnxUIFont, nil, 12)
